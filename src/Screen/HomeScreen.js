...
const navigation = {
  categories: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          name: 'Accessories',
          items: [
            { name: 'Watches', href: '/col' },
            { name: 'Wallets', href: '/col' },
            { name: 'Bags', href: '/col' },
            { name: 'Sunglasses', href: '/col' },
            { name: 'Hats', href: '/col' },
            { name: 'Belts', href: '/col' },
          ],
        },
        {
          ...
          name: 'Brands',
          items: [
            { name: 'Full Nelson', href: '/col' },
            { name: 'My Way', href: '/col' },
            { name: 'Re-Arranged', href: '/col' },
            { name: 'Counterfeit', href: '/col' },
            { name: 'Significant Other', href: '/col' },
          ],
        },
      ],
    },
  ...
  pages: [
    { name: 'Company', href: '/col' },
    { name: 'Stores', href: '/col' },
  ],
}
const favorites = [
  {
...
const footerNavigation = {
  ...
  account: [
    { name: 'Manage Account', href: '/product' },
    { name: 'Returns & Exchanges', href: '/product' },
    { name: 'Redeem a Gift Card', href: '/product' },
  ],
  connect: [
    { name: 'Contact Us', href: '/product' },
    { name: 'Twitter', href: '/product' },
    { name: 'Instagram', href: '/product' },
    { name: 'Pinterest', href: '/product' },
  ],
}
